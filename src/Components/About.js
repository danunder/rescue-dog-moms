...
import "../App.css";
import YamandBoss from '../Images/yamandboss2.jpeg'
...
function About() {
  return (
    <div className="about">
      ...
      <strong>Want to adopt or foster in the GTA?</strong> It is important you do your research on which rescue you do that through.</p>
      {/* <ul>
